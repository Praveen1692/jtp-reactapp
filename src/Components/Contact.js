      ...
      <div className="contact-body">
        <Grid className="contact-grid">
          ...
          <Cell col={6}>
              ...
              <List>
                  <ListItem>
                      <ListItemContent style={{fontSize: '25px', fontFamily: 'Anton'}}><i className="fa fa-phone-square" aria-hidden='true'></i>+91 7310736712</ListItemContent>
                  </ListItem>
                  <ListItem>
                      <ListItemContent style={{fontSize: '25px', fontFamily: 'Anton'}}><i className="fa fa-envelope" aria-hidden='true'></i>praying.sharma@gmail.com</ListItemContent>
                  </ListItem>
              </List>
              </div>
          </Cell>
